    ...
    function CodeGenerator(AllMatrices,EngineName,varargin)
...
%     PrtFuncName(fid,EngineName,'Ts0',ArgType,ArgName,RetType);
...
%     PrtFuncName(fid,EngineName,'FNcMaxCont',ArgType,ArgName,RetType);
...
%     
%     %Cold Sub-Idle matrices
%     PrtFuncName(fid,EngineName,'Awm',ArgType,ArgName,RetType);    
%     PrtFuncName(fid,EngineName,'Bwm',ArgType,ArgName,RetType);
%     PrtFuncName(fid,EngineName,'Cwm',ArgType,ArgName,RetType);    
%     PrtFuncName(fid,EngineName,'Dwm',ArgType,ArgName,RetType);
%     PrtFuncName(fid,EngineName,'RPMwm',ArgType,ArgName,RetType);  
%     
%     %Hot Sub-Idle matrices
%     PrtFuncName(fid,EngineName,'Ash',ArgType,ArgName,RetType);    
%     PrtFuncName(fid,EngineName,'Bsh',ArgType,ArgName,RetType);
%     PrtFuncName(fid,EngineName,'Pt3Csh',ArgType,ArgName,RetType);    
%     PrtFuncName(fid,EngineName,'Pt3Dsh',ArgType,ArgName,RetType);
%     PrtFuncName(fid,EngineName,'Tt4Csh',ArgType,ArgName,RetType);    
%     PrtFuncName(fid,EngineName,'Tt4Dsh',ArgType,ArgName,RetType);
%     PrtFuncName(fid,EngineName,'NcFANsh',ArgType,ArgName,RetType);
%     PrtFuncName(fid,EngineName,'Wfsh',ArgType,ArgName,RetType);
%     PrtFuncName(fid,EngineName,'Tt4sh',ArgType,ArgName,RetType);
%     PrtFuncName(fid,EngineName,'Pt3sh',ArgType,ArgName,RetType);
%     PrtFuncName(fid,EngineName,'RPMsh',ArgType,ArgName,RetType);    
% 
%     %Reference Filter Vectors
%     PrtFuncName(fid,EngineName,'ASVec',ArgType,ArgName,RetType);
%     PrtFuncName(fid,EngineName,'DSVec',ArgType,ArgName,RetType);
%     PrtFuncName(fid,EngineName,'NcVec',ArgType,ArgName,RetType);
%     
% %     %Fuel and Oil Pump Bias Correction Vectors
% %     PrtFuncName(fid,EngineName,'FPInVec',ArgType,ArgName,RetType);    
% %     PrtFuncName(fid,EngineName,'FPOutVec',ArgType,ArgName,RetType);
% %     PrtFuncName(fid,EngineName,'OPInVec',ArgType,ArgName,RetType);    
% %     PrtFuncName(fid,EngineName,'OPOutVec',ArgType,ArgName,RetType);  
...
%     %Calculates the elements of the static temperature matrix
%     [rows, columns,pages] = size(Ts0);
%     Ambient_Elem_Word = num2str(rows*columns*pages);
%     %Ptints Ts0 Matrix in a separate file
%     Prt3DCMtx(EngineName,'Ts0Mtx',Ts0,Ambient_Elem_Word,ArgType,ArgName,RetType,cFolderName);
%     %Calculates the elements of the remaninig Ambient Matrices
...
%     Prt3DCMtx(EngineName,'AltLinVec',AltLinVec,num2str(length(AltLinVec)),ArgType,ArgName,RetType,cFolderName);
%     Prt3DCMtx(EngineName,'MNLinVec',MNLinPoints,num2str(length(MNLinPoints)),ArgType,ArgName,RetType,cFolderName);
%     Prt3DCMtx(EngineName,'FNcMaxContMtx',FNcMaxCont,num2str(length(MNLinPoints)),ArgType,ArgName,RetType,cFolderName);
%     
%     %Cold Sub-Idle matrices
%     Prt3DCMtx(EngineName,'AwmMtx',Awm,num2str(length(MNLinPoints)),ArgType,ArgName,RetType,cFolderName);
%     Prt3DCMtx(EngineName,'BwmMtx',Bwm,num2str(length(MNLinPoints)),ArgType,ArgName,RetType,cFolderName);
%     Prt3DCMtx(EngineName,'CwmMtx',Cwm,num2str(length(MNLinPoints)),ArgType,ArgName,RetType,cFolderName);
%     Prt3DCMtx(EngineName,'DwmMtx',Dwm,num2str(length(MNLinPoints)),ArgType,ArgName,RetType,cFolderName);
%     Prt3DCMtx(EngineName,'RPMwmMtx',RPMwm,num2str(length(MNLinPoints)),ArgType,ArgName,RetType,cFolderName);
%     
%     %Hot Sub-Idle matrices
%     [Rowsh,Colsh] = size(Ash);
%     RowColsh = Rowsh * Colsh;
%     Prt3DCMtx(EngineName,'AshMtx',Ash,num2str(RowColsh),ArgType,ArgName,RetType,cFolderName);
%     Prt3DCMtx(EngineName,'BshMtx',Bsh,num2str(RowColsh),ArgType,ArgName,RetType,cFolderName);
%     Prt3DCMtx(EngineName,'Pt3CshMtx',Pt3Csh,num2str(RowColsh),ArgType,ArgName,RetType,cFolderName);
%     Prt3DCMtx(EngineName,'Pt3DshMtx',Pt3Dsh,num2str(RowColsh),ArgType,ArgName,RetType,cFolderName);
%     Prt3DCMtx(EngineName,'Tt4CshMtx',Tt4Csh,num2str(RowColsh),ArgType,ArgName,RetType,cFolderName);
%     Prt3DCMtx(EngineName,'Tt4DshMtx',Tt4Dsh,num2str(RowColsh),ArgType,ArgName,RetType,cFolderName);
%     Prt3DCMtx(EngineName,'NcFANshMtx',NcFANsh,num2str(RowColsh),ArgType,ArgName,RetType,cFolderName);
%     Prt3DCMtx(EngineName,'WfshMtx',Wfsh,num2str(RowColsh),ArgType,ArgName,RetType,cFolderName);
%     Prt3DCMtx(EngineName,'Tt4shMtx',Tt4sh,num2str(RowColsh),ArgType,ArgName,RetType,cFolderName);
%     Prt3DCMtx(EngineName,'Pt3shMtx',Pt3sh,num2str(RowColsh),ArgType,ArgName,RetType,cFolderName);
%     Prt3DCMtx(EngineName,'RPMshMtx',RPMsh,num2str(RowColsh),ArgType,ArgName,RetType,cFolderName);
%     
%     %Reference Filter Vectors
%     Prt3DCMtx(EngineName,'ASVec',ASVec,num2str(length(ASVec)),ArgType,ArgName,RetType,cFolderName);
%     Prt3DCMtx(EngineName,'DSVec',DSVec,num2str(length(DSVec)),ArgType,ArgName,RetType,cFolderName);
%     Prt3DCMtx(EngineName,'NcVec',NcVec,num2str(length(NcVec)),ArgType,ArgName,RetType,cFolderName);
%     
% %     %Fuel and Oilt Pumps Bias Correction Vectors
% %     Prt3DCMtx(EngineName,'FPInVec',FuelPumpIn,num2str(length(FuelPumpIn)),ArgType,ArgName,RetType,cFolderName);
% %     Prt3DCMtx(EngineName,'FPOutVec',FuelPumpOut,num2str(length(FuelPumpOut)),ArgType,ArgName,RetType,cFolderName);
% %     Prt3DCMtx(EngineName,'OPInVec',OilPumpIn,num2str(length(OilPumpIn)),ArgType,ArgName,RetType,cFolderName);
% %     Prt3DCMtx(EngineName,'OPOutVec',OilPumpOut,num2str(length(OilPumpOut)),ArgType,ArgName,RetType,cFolderName);
    ...
    val = {'AltLinVec'};
    Index = strcmp('AltLinVec',AllMatrices);    
    word = ['\n\n' '/* Number altitude points used for gains calculation */'];
    fprintf(fid,word);
    word = ['\n' 'Alt_Elem = ' num2str(length(varargin{Index})) ';'];
    fprintf(fid,word);
    
    val = {'MNLinVec'};
    Index = strcmp('MNLinVec',AllMatrices);  
    word = ['\n\n' '/* Number of Mach number points used for gains calculation */'];
    fprintf(fid,word);
    word = ['\n' 'MN_Elem = ' num2str(length(varargin{Index})) ';'];
    fprintf(fid,word);
    
    Index = strcmp('NcFANMtx',AllMatrices);  
    word = ['\n\n' '/* Number of steady operating points used for linearization at Sea Level */'];
    fprintf(fid,word);
    Value = varargin{Index};
    word = ['\n' 'FN_Elem = ' num2str(length(Value(1,:))) ';'];
    fprintf(fid,word);
    
    Index = strcmp('AMtx',AllMatrices);  
    Value = varargin{Index};
    [row,col,page] = size(Value);
    SteadyOp_Elem_Word = num2str(row * col * page);
    word = ['\n\n' '/* Number of steady operating points used for linearization at Sea Level */'];
    fprintf(fid,word);
    word = ['\n' 'SteadyOp_Elem = ' SteadyOp_Elem_Word ';'];
    fprintf(fid,word);

    Index = strcmp('N_KiMtx',AllMatrices);  
    Value = varargin{Index};
    [row,col,page] = size(Value);
    PowerMan_Elem_Word = num2str(row * col * page);
...
%     word = ['\n\n' '/* Number of total points for fuel pump bias correction */'];
%     fprintf(fid,word);
%     word = ['\n' 'FuelPump_Elem = ' num2str(length(FuelPumpIn(1,:))) ';'];
%     fprintf(fid,word);
%     
%     word = ['\n\n' '/* Number of total points for fuel pump bias correction */'];
%     fprintf(fid,word);
%     word = ['\n' 'OilPump_Elem = ' num2str(length(OilPumpIn(1,:))) ';'];
%     fprintf(fid,word);
    ...
    Index = strcmp('NcFANMap',AllMatrices);  
    Value = varargin{Index};
    [row,col,page] = size(Value);
    NcFANMap_Elem_Word = num2str(row * col * page);
    word = ['\n' 'NcFANMap_Elem = ' NcFANMap_Elem_Word ';'];
    fprintf(fid,word); 
    
    Index = strcmp('WcFANMap',AllMatrices);  
    Value = varargin{Index};
    [row,col,page] = size(Value);
    WcFANMap_Elem_Word = num2str(row * col * page);
    ...
    Index = strcmp('NcHPCMap',AllMatrices);  
    Value = varargin{Index};
    [row,col,page] = size(Value);
    NcHPCMap_Elem_Word = num2str(row * col * page);
    word = ['\n' 'NcHPCMap_Elem = ' NcHPCMap_Elem_Word ';'];
    fprintf(fid,word); 
    
    Index = strcmp('WcHPCMap',AllMatrices);  
    Value = varargin{Index};
    [row,col,page] = size(Value);
    WcHPCMap_Elem_Word = num2str(row * col * page);
    ...
    Index = strcmp('NcHPTMap',AllMatrices);  
    Value = varargin{Index};
    [row,col,page] = size(Value);
    NcHPTMap_Elem_Word = num2str(row * col * page);
    word = ['\n' 'NcHPTMap_Elem = ' NcHPTMap_Elem_Word ';'];
    fprintf(fid,word);
    
    Index = strcmp('PRHPTMap',AllMatrices);  
    Value = varargin{Index};
    [row,col,page] = size(Value);
    PRHPTMap_Elem_Word = num2str(row * col * page);
    word = ['\n' 'PRHPTMap_Elem = ' PRHPTMap_Elem_Word ';'];
    fprintf(fid,word);
    
    Index = strcmp('WcHPTMap',AllMatrices); 
    Value = varargin{Index};
    [row,col,page] = size(Value);
    WcHPTMap_Elem_Word = num2str(row * col * page);

...
#define TJ1200_NDES						23042//22972
#define TJ1200_Ath_NOZZLE				0.0281//0.0301
...
#define TJ1200_Tt4_CLSAFESTART          1120//1038//1149//1300//790//950     /* K - Safe start temperature value */
#define TJ1200_Tt4_CLRAMPCOEF           10//50//2000         /* K / s - Ramp coefficient value for the safe temperature reference during start */
#define TJ1200_Tt4_RAMPDECFAST         1173          /* K - Temerature value where fuel decrease ramp, during engine start, becomes faster for better engine protection */
...
#define TJ1200_FUEL_RAMP                0.0012//0.0025//0.003//0.002//0.00175		// = 0.01 * 0.175 - Absolute/Second (1% every second) - CHANGE IF MAXIMUM VALUE IS CHANGED!!!
#define TJ1200_FUEL_PERC				0.2 //0.1 -> At TestBench		//Percentual Value
#define TJ1200_FUEL_RAMP_LOW			0.0008//0.0006//0.000875//0.000475 // = 0.005 * 0.175 - //Absolute/Second (0.5% every second) - CHANGE IF MAXIMUM VALUE IS CHANGED!!!
...
#define TJ1200_TT4MAX					1157//1152
#define TJ1200_TT4MAXREF                1152
...
#define TJ1200_WFMAX					0.1669//0.2835//0.175 //0.2-> At TestBench			//kg/s
...
#define TJ1200_BEAR_OPRPMINT            2200    /* RPM - Intermediate oil pump rotation speed */
#define TJ1200_BEAR_OPRPMMAX            9000//4500 /* RPM */          /* Maximum oil pump RPM value */
#define TJ1200_BEAR_OPRPMMIN            1100//300 /* RPM */          /* Minimum oil pump RPM value */

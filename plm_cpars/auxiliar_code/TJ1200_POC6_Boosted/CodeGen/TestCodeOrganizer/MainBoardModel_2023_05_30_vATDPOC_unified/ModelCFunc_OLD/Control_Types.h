...
struct ControllerConstants
{
    ...
    double NMaxRef, Tt4MaxRef, Tt5MaxRef;
    ...
    /* Tt4 Parameters */
    double Tt4AvFlameOn, Tt4AvMax, Tt4CLSafeStart, Tt4CLRampCoef, Tt4RampDecFast;
    ...
    double WfRampDec, WfRampDecFast, WfRampDecLowLim;
    double WfKdStart;
    ...
    double TimeBearOverTemp[5];

    /* Short-Open sensor values */
    double RPMShort, RPMOpen;
    double PSOpen, PSOpenThresh, PSShort, PSShortThresh;
    double PFuelOpen, PFuelShort;
    double POilOpen, POilShort;
    double VibOpen, VibOpenThresh, VibShort, VibShortThresh;
    double TCOpen;

    /* Thresholds */
    double TCThreshold, Ts2Threshold, Tt4Threshold, Tt4ShaftLock, Tt4BlowOut;
    double PSThreshold, Pt3Threshold, Pt3ShaftLock, Pt3BlowOut;
    double VibThreshold;
    double RPMThreshold, RPMShaftLock, RPMBlowOut;
    double POilThreshold, PFuelThreshold;
    ...
    /* BEARINGS PARAMETERS */
    int NumBear;
    double KpBear, KiBear, KbBear, OPRPMInt, OPRPMMax, OPRPMMin, RPMOilInt, RPMOilOn;
    double TMaxBear[5], TRefBear[5];
...
struct ControllerInput
{
    ...
    double TimeSD;
    double TimeToRampSD;    /* Time allowed before ramp execution in nominal shut off */
    double TimeToEmergSD;   /* Time allowed before emergency sequence execution in nominal shut off */

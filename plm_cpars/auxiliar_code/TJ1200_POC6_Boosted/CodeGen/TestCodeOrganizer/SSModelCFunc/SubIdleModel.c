...
int WindMillingModel(struct EnginePars *ParsP, double *AwmMtxP, double BwmMtxP, double *RPMwmMtxP, double *MNLinVecP, double RPM, double sqrTheta)
{
	...
	double Nc = RPM / sqrTheta;
	/* Calculates current value of uss - Mach numer value */
	...
	InterpInd3DRPM(0, 0, Nc, &DummyVec, &DummyVec, RPMwmMtxP, Mtx2DP, Mtx2DHP, Mtx1DP, Mtx1DHP, Alt_Elem, MN_Elem, Fn_Elem, &Index3D);

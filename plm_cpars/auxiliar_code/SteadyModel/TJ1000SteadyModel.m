function [Thrust,RPM,Wf] = TJ1000SteadyModel(Altitude, MN, dT, Input, FNcMtx, N2cMtx, WfcMtx, AltVec, MNVec, P0Vec, T0Vec, NDes, WhitchInput)
...
% [k1H,k1L,f1,k2H,k2L,f2,k3H,k3L,f3] = Lookup3d(AltVec,MNVec,Mtx3D,Altitude,MN,InputC);

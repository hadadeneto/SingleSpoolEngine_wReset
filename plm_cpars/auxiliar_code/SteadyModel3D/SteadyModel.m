...
% VecOrigin = N2cMtx(1,:);
% BPOrigin = FNcMtx(1,:);
% NewVec = VectorMaker(FNcVec,BPOrigin,VecOrigin);
BPMtxOrigin = FNcMtx;
BPNew = FNcVec;

MtxOrigin = N2cMtx;
N2cMtxNew = MtxMaker(MtxOrigin,BPMtxOrigin,BPNew);
MtxOrigin = WfcMtx;
WfcMtxNew = MtxMaker(MtxOrigin,BPMtxOrigin,BPNew);

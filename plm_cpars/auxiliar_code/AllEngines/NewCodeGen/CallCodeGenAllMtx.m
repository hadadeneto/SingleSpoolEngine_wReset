...
%Function name
OutputName = '[AllgetCSource, AllgetHSource] = ';
FuncName = 'CodeGenAllMtx';
FuncName = [OutputName FuncName];
%Sorts for alphabetic order
AllMatrices = sort(AllMatrices);
%Word do be used as function inputs
cellsword = [{'AllMatrices'},{'GetFuncMatrices'},{'GetFuncConst'},{'VarsPerLine'},{'EngineName'},{'EngFoldName'}];

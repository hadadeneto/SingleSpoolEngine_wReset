...
function [AllgetCSource, AllgetHSource] = CodeGenAllMtx(AllMatrices,GetFuncMatrices,GetFuncConst,VarsPerLine,EngineName,EngFoldName,varargin)
...
cFolderName = [EngFoldName filesep 'All_get_C'];%'c_Files_Test';
hFolderName = [EngFoldName filesep 'All_get_H'];%'h_Files_Test';
AllgetCSource = cFolderName;
AllgetHSource = hFolderName;

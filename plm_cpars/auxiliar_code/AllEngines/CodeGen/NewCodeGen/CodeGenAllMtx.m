...
function [AllgetCSource, AllgetHSource] = CodeGenAllMtx(AllMatrices,GetFuncMatrices,GetFuncConst,VarsPerLine,EngineName,varargin)
...
cFolderName = 'All_get_C';%'c_Files_Test';
hFolderName = 'All_get_H';%'h_Files_Test';

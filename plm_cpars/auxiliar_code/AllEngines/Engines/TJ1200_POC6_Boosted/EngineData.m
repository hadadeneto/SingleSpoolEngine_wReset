...
% ASVec = [1.09, 1.08, 1.06, 1.08, 1.09, 1.011]; %Used in Formosa 3 flight!!
ASVec = [2, 2, 2, 2, 2, 2];
...
fcp = 2.6526e-01;%=1.6667 * 1.5915e-01;%A = -1.6667 %Used in flight!!!
% fcp = 1.7 * 1.5915e-01;
...
%Defines parameters for PI Calculations - This configuration has been used
%in the first flight
PM = 55;
wcMin = 0.2;
wcMax = .6;

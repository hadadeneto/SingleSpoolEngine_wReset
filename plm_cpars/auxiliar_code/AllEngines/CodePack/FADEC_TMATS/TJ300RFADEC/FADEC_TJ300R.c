...
#define S_FUNCTION_NAME  FADEC_TJ300R
...
/******** COMMENT END *********/
    ...
    int Fn_Elem = TJ300R_FN_ELEM;                      /* Number of net thrust breakpoint elements */
    int MN_Elem = TJ300R_MN_ELEM;                      /* Number of Mach number breakpoint elements */
    ...
    // floating AltLinVec[TJ300R_ALT_ELEM];                      /* Altitude breakpoints */
    // floating AMtx[TJ300R_MN_ELEM * TJ300R_FN_ELEM];           /* Model - A matrix */
    // floating ASVec[TJ300R_AS_ELEM];                           /* Controller - Asceleration schedule (ASVec) break points */
    // floating BMtx[TJ300R_MN_ELEM * TJ300R_FN_ELEM];           /* Model - B matrix */
    // floating DeltaMtx[TJ300R_ALT_ELEM * TJ300R_MN_ELEM];      /* Controller - Delta matrix */
    // floating DeltaMtx1D[TJ300R_MN_ELEM];                      /* Auxiliar matrix - Delta */
    // floating DeltaMtx1DH[TJ300R_MN_ELEM];                     /* Auxiliar matrix - Delta */
    // floating DeltaMtx2D[TJ300R_ALT_ELEM * TJ300R_MN_ELEM];    /* Auxiliar matrix - Delta */
    // floating DeltaMtx2DH[TJ300R_ALT_ELEM * TJ300R_MN_ELEM];   /* Auxiliar matrix - Delta */
    // floating DSVec[TJ300R_AS_ELEM];                           /* Controller - Deceleration schedule (DSVec) break points */
    // floating FNcMaxContMtx[TJ300R_MN_ELEM];                   /* Controller - Maximum corrected net thrust values */
    // floating FNperContMtx[TJ300R_TOTAL_ELEM];                 /* Controller - net thrust percentual values matrix */
    // floating MapHPC1D[TJ300R_FAN_PR];                         /* Auxiliar matrix - HPC map */
    // floating MapHPC1DH[TJ300R_FAN_PR];                        /* Auxiliar matrix - HPC map */
    // floating MapHPC2D[TJ300R_FAN_NC * TJ300R_FAN_PR];         /* Auxiliar matrix - HPC map */
    // floating MapHPC2DH[TJ300R_FAN_NC * TJ300R_FAN_PR];        /* Auxiliar matrix - HPC map */
    // floating MNLinVec[TJ300R_MN_ELEM];                        /* Mach number breakpoints */
    // floating Mtx1D[TJ300R_FN_ELEM];                           /* Auxiliar matrix */
    // floating Mtx1DH[TJ300R_FN_ELEM];                          /* Auxiliar matrix */
    // floating Mtx2D[TJ300R_MN_ELEM * TJ300R_FN_ELEM];          /* Auxiliar matrix */
    // floating Mtx2DH[TJ300R_MN_ELEM * TJ300R_FN_ELEM];         /* Auxiliar matrix */
    // floating N_KiMtx[TJ300R_TOTAL_ELEM];                      /* Controller - Ki matrix of N control law */
    // floating N_KpMtx[TJ300R_TOTAL_ELEM];                      /* Controller - Kp matrix of N control law */
    // floating NcFANContMtx[TJ300R_TOTAL_ELEM];                 /* Controller - Fan Nc breakpoints */
    // floating NcHPCMapMtx[TJ300R_FAN_NC];                      /* Model - Nc break points matrix - HPC map */
    // floating NcVec[TJ300R_AS_ELEM];                           /* Controller - Nc schedule (for ASVec and DSVec) break points */
    // floating PRHPCMapMtx[TJ300R_FAN_NC * TJ300R_FAN_PR];      /* Model - PR break points matrix - HPC map */
    // floating Pt3DMtx[TJ300R_MN_ELEM * TJ300R_FN_ELEM];        /* Model - Pt3D matrix */
    // floating Pt3Mtx[TJ300R_MN_ELEM * TJ300R_FN_ELEM];         /* Model - Pt3 matrix */
    // floating Pt5DMtx[TJ300R_MN_ELEM * TJ300R_FN_ELEM];        /* Model - Pt5D matrix */
    // floating Pt5Mtx[TJ300R_MN_ELEM * TJ300R_FN_ELEM];         /* Model - Pt5 matrix */
    // floating Ts0Mtx[TJ300R_ALT_ELEM];                         /* Controller and Model - Ts0 break points  */
    // floating Ts0Mtx1D[TJ300R_ALT_ELEM];                       /* Auxiliar matrix - Ts0 */
    // floating Ts0Mtx1DH[TJ300R_ALT_ELEM];                      /* Auxiliar matrix - Ts0 */
    // floating Ts0Mtx2D[TJ300R_FN_ELEM];                        /* Auxiliar matrix - Ts0 */
    // floating Ts0Mtx2DH[TJ300R_FN_ELEM];                       /* Auxiliar matrix - Ts0 */
    // floating Tt4DMtx[TJ300R_MN_ELEM * TJ300R_FN_ELEM];        /* Model - Tt4D matrix */
    // floating Tt4Mtx[TJ300R_MN_ELEM * TJ300R_FN_ELEM];         /* Model - Tt4 matrix */
    // floating Tt5DMtx[TJ300R_MN_ELEM * TJ300R_FN_ELEM];        /* Model - Tt5D matrix */
    // floating Tt5Mtx[TJ300R_MN_ELEM * TJ300R_FN_ELEM];         /* Model - Tt5 matrix */
    // floating WcHPCMapMtx[TJ300R_FAN_NC * TJ300R_FAN_PR];      /* Model - Wc break points matrix - HPC map */
    // floating WfMtx[TJ300R_MN_ELEM * TJ300R_FN_ELEM];          /* Model - Wf matrix */
...
/******** SAVETO START: FADEC_LOADPARS *********/
    ...
    getTJ300RFADECSizeConst(&Alt_Elem, &MN_Elem, &Fn_Elem, &AS_Elem, &SteadyOp_Elem,
    ...
    getTJ300RFADECContConst(&ContConst);

    /* Loads FADEC matrices */
    getTJ300RFADECMtx(AMtx, ASVec, AltLinVec, BMtx, DSVec,
    ...
    // getTJ300RFADECMtx(&AMtx[0], &ASVec[0], &AltLinVec[0], &BMtx[0], &DSVec[0],
...
/******** COMMENT END *********/
		...
		/*=====================================================================*/
		/*   START OF SSModelLoop.c AND PIMMRF_TJ300R.c IDENTICAL CODE PIECE   */
		/*																       */
...
//mexPrintf("Model: BoostL=%d BoostR=%d Time=%f status=%d Delta=%f Pt3=%f\n",BoosterLStatus, BoosterRStatus, ContInModCL.TimerBoost, ContInModCL.statusBooster, Delta, ContInModCL.Pt3);
        ...
        /*===============================================================*/
        /* END OF SSModelLoop.c AND PIMMRF_TJ300R.c IDENTICAL CODE PIECE */
        /*                                                               */

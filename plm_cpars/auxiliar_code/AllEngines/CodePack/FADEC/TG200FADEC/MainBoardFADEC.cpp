 ...
 * ***********************************************************************************************/
#define VERSAO_DO_DIA   "FADEC Versao do dia 26/07/2024 DEV - UAVCAN e Code Generator"
...
//#include "getTG200.h"              /* File containing all get functions for TG200 */
...
/* Engine .h files */
#include "TG200/FADEC_Constants_H/ConstantsTG200.h"
#include "TG200/FADEC_get_H/getTG200FADECContConst.h"
#include "TG200/FADEC_get_H/getTG200FADECMtx.h"       /* TG200 Engine Constants */
#include "TG200/FADEC_get_H/getTG200FADECSizeConst.h"
...
/******** COMMENT END *********/
    ...
    int Fn_Elem = TG200_FN_ELEM;                      /* Number of net thrust breakpoint elements */
    int MN_Elem = TG200_MN_ELEM;                      /* Number of Mach number breakpoint elements */
    ...
    // floating AltLinVec[TG200_ALT_ELEM];                      /* Altitude breakpoints */
    // floating AMtx[TG200_MN_ELEM * TG200_FN_ELEM];           /* Model - A matrix */
    // floating ASVec[TG200_AS_ELEM];                           /* Controller - Asceleration schedule (ASVec) break points */
    // floating BMtx[TG200_MN_ELEM * TG200_FN_ELEM];           /* Model - B matrix */
    // floating DeltaMtx[TG200_ALT_ELEM * TG200_MN_ELEM];      /* Controller - Delta matrix */
    // floating DeltaMtx1D[TG200_MN_ELEM];                      /* Auxiliar matrix - Delta */
    // floating DeltaMtx1DH[TG200_MN_ELEM];                     /* Auxiliar matrix - Delta */
    // floating DeltaMtx2D[TG200_ALT_ELEM * TG200_MN_ELEM];    /* Auxiliar matrix - Delta */
    // floating DeltaMtx2DH[TG200_ALT_ELEM * TG200_MN_ELEM];   /* Auxiliar matrix - Delta */
    // floating DSVec[TG200_AS_ELEM];                           /* Controller - Deceleration schedule (DSVec) break points */
    // floating FNcMaxContMtx[TG200_MN_ELEM];                   /* Controller - Maximum corrected net thrust values */
    // floating FNperContMtx[TG200_TOTAL_ELEM];                 /* Controller - net thrust percentual values matrix */
    // floating MapHPC1D[TG200_FAN_PR];                         /* Auxiliar matrix - HPC map */
    // floating MapHPC1DH[TG200_FAN_PR];                        /* Auxiliar matrix - HPC map */
    // floating MapHPC2D[TG200_FAN_NC * TG200_FAN_PR];         /* Auxiliar matrix - HPC map */
    // floating MapHPC2DH[TG200_FAN_NC * TG200_FAN_PR];        /* Auxiliar matrix - HPC map */
    // floating MNLinVec[TG200_MN_ELEM];                        /* Mach number breakpoints */
    // floating Mtx1D[TG200_FN_ELEM];                           /* Auxiliar matrix */
    // floating Mtx1DH[TG200_FN_ELEM];                          /* Auxiliar matrix */
    // floating Mtx2D[TG200_MN_ELEM * TG200_FN_ELEM];          /* Auxiliar matrix */
    // floating Mtx2DH[TG200_MN_ELEM * TG200_FN_ELEM];         /* Auxiliar matrix */
    // floating N_KiMtx[TG200_TOTAL_ELEM];                      /* Controller - Ki matrix of N control law */
    // floating N_KpMtx[TG200_TOTAL_ELEM];                      /* Controller - Kp matrix of N control law */
    // floating NcFANContMtx[TG200_TOTAL_ELEM];                 /* Controller - Fan Nc breakpoints */
    // floating NcHPCMapMtx[TG200_FAN_NC];                      /* Model - Nc break points matrix - HPC map */
    // floating NcVec[TG200_AS_ELEM];                           /* Controller - Nc schedule (for ASVec and DSVec) break points */
    // floating PRHPCMapMtx[TG200_FAN_NC * TG200_FAN_PR];      /* Model - PR break points matrix - HPC map */
    // floating Pt3DMtx[TG200_MN_ELEM * TG200_FN_ELEM];        /* Model - Pt3D matrix */
    // floating Pt3Mtx[TG200_MN_ELEM * TG200_FN_ELEM];         /* Model - Pt3 matrix */
    // floating Pt5DMtx[TG200_MN_ELEM * TG200_FN_ELEM];        /* Model - Pt5D matrix */
    // floating Pt5Mtx[TG200_MN_ELEM * TG200_FN_ELEM];         /* Model - Pt5 matrix */
    // floating Ts0Mtx[TG200_ALT_ELEM];                         /* Controller and Model - Ts0 break points  */
    // floating Ts0Mtx1D[TG200_ALT_ELEM];                       /* Auxiliar matrix - Ts0 */
    // floating Ts0Mtx1DH[TG200_ALT_ELEM];                      /* Auxiliar matrix - Ts0 */
    // floating Ts0Mtx2D[TG200_FN_ELEM];                        /* Auxiliar matrix - Ts0 */
    // floating Ts0Mtx2DH[TG200_FN_ELEM];                       /* Auxiliar matrix - Ts0 */
    // floating Tt4DMtx[TG200_MN_ELEM * TG200_FN_ELEM];        /* Model - Tt4D matrix */
    // floating Tt4Mtx[TG200_MN_ELEM * TG200_FN_ELEM];         /* Model - Tt4 matrix */
    // floating Tt5DMtx[TG200_MN_ELEM * TG200_FN_ELEM];        /* Model - Tt5D matrix */
    // floating Tt5Mtx[TG200_MN_ELEM * TG200_FN_ELEM];         /* Model - Tt5 matrix */
    // floating WcHPCMapMtx[TG200_FAN_NC * TG200_FAN_PR];      /* Model - Wc break points matrix - HPC map */
    // floating WfMtx[TG200_MN_ELEM * TG200_FN_ELEM];          /* Model - Wf matrix */
...
floating FNIdle = 1800; /* VARIAVEL PARA TESTE */
                                                                                                ...
                                                                                                //in order to finish any task during this interval of 20ms.
        {
            ...
            printf("SkipStart=%d, Authorize=%d, Wf0=%f\n\n", SkipStart, Authorize, Wf0);
                    ...
                    case HILS_FADEC_RESET_CANID:
                        ...
                        if(resetMode.value.starting_mode == 0)      //Update 26/07/2024: 0: Auto Start Ground, 1: Manual Start Ground, 2: Auto Start Flight
                        {
                            Mode = 0;   //Auto
                        }

                        else if(resetMode.value.starting_mode == 1)
                        {
                            Mode = 1;   //Manual
                        }

                        else if(resetMode.value.starting_mode == 2)
                        {
                            Mode = 0;   //Auto
                        }
...
//        RPMOilPump = eRPMOil / (POLES_BLDC_OILPUMP/2);  //as on https://discuss.ardupilot.org/t/how-to-read-rpm-signal-from-esc/8326/2?page=2
    ...
    else if(key.compare("_mo") == 0)		//Update 24/07/2024: Mode: 'g' Auto Start Ground, 'm' Manual Start, 'f' Auto Start Flight   //OLD >> Mode: 'a' Automatic, 'm' Manual
	{
...
/******** REPLACE START: getTJ1200ContConst BY getTJ1200FADECContConst *********/
    /* LOADING OF CONTROLLER CONSTANTS */
      getTJ1200FADECContConst (&ContConst);   //QUAL O MOTIVO DE CHAMAR AQUI DE NOVO??
...
//printf("Model: BoostL=%d BoostR=%d Time=%f status=%d Delta=%f Pt3=%f\n",BoosterLStatus, BoosterRStatus, ContInModCL.TimerBoost, ContInModCL.statusBooster, Delta, ContInModCL.Pt3);
        ...
        /*===============================================================*/
        /* END OF SSModelLoop.c AND PIMMRF_TG200.c IDENTICAL CODE PIECE */
        /*                                                               */

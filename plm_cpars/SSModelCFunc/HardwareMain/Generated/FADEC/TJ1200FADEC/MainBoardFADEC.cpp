...
/******** COMMENT END *********/
    ...
    // floating AltLinVec[TJ1200_ALT_ELEM];                      /* Altitude breakpoints */
    // floating AMtx[TJ1200_MN_ELEM * TJ1200_FN_ELEM];           /* Model - A matrix */
    // floating ASVec[TJ1200_AS_ELEM];                           /* Controller - Asceleration schedule (ASVec) break points */
    // floating BMtx[TJ1200_MN_ELEM * TJ1200_FN_ELEM];           /* Model - B matrix */
    // floating DeltaMtx[TJ1200_ALT_ELEM * TJ1200_MN_ELEM];      /* Controller - Delta matrix */
    // floating DeltaMtx1D[TJ1200_MN_ELEM];                      /* Auxiliar matrix - Delta */
    // floating DeltaMtx1DH[TJ1200_MN_ELEM];                     /* Auxiliar matrix - Delta */
    // floating DeltaMtx2D[TJ1200_ALT_ELEM * TJ1200_MN_ELEM];    /* Auxiliar matrix - Delta */
    // floating DeltaMtx2DH[TJ1200_ALT_ELEM * TJ1200_MN_ELEM];   /* Auxiliar matrix - Delta */
    // floating DSVec[TJ1200_AS_ELEM];                           /* Controller - Deceleration schedule (DSVec) break points */
    // floating FNcMaxContMtx[TJ1200_MN_ELEM];                   /* Controller - Maximum corrected net thrust values */
    // floating FNperContMtx[TJ1200_TOTAL_ELEM];                 /* Controller - net thrust percentual values matrix */
    // floating MapHPC1D[TJ1200_FAN_PR];                         /* Auxiliar matrix - HPC map */
    // floating MapHPC1DH[TJ1200_FAN_PR];                        /* Auxiliar matrix - HPC map */
    // floating MapHPC2D[TJ1200_FAN_NC * TJ1200_FAN_PR];         /* Auxiliar matrix - HPC map */
    // floating MapHPC2DH[TJ1200_FAN_NC * TJ1200_FAN_PR];        /* Auxiliar matrix - HPC map */
    // floating MNLinVec[TJ1200_MN_ELEM];                        /* Mach number breakpoints */
    // floating Mtx1D[TJ1200_FN_ELEM];                           /* Auxiliar matrix */
    // floating Mtx1DH[TJ1200_FN_ELEM];                          /* Auxiliar matrix */
    // floating Mtx2D[TJ1200_MN_ELEM * TJ1200_FN_ELEM];          /* Auxiliar matrix */
    // floating Mtx2DH[TJ1200_MN_ELEM * TJ1200_FN_ELEM];         /* Auxiliar matrix */
    // floating N_KiMtx[TJ1200_TOTAL_ELEM];                      /* Controller - Ki matrix of N control law */
    // floating N_KpMtx[TJ1200_TOTAL_ELEM];                      /* Controller - Kp matrix of N control law */
    // floating NcFANContMtx[TJ1200_TOTAL_ELEM];                 /* Controller - Fan Nc breakpoints */
    // floating NcHPCMapMtx[TJ1200_FAN_NC];                      /* Model - Nc break points matrix - HPC map */
    // floating NcVec[TJ1200_AS_ELEM];                           /* Controller - Nc schedule (for ASVec and DSVec) break points */
    // floating PRHPCMapMtx[TJ1200_FAN_NC * TJ1200_FAN_PR];      /* Model - PR break points matrix - HPC map */
    // floating Pt3DMtx[TJ1200_MN_ELEM * TJ1200_FN_ELEM];        /* Model - Pt3D matrix */
    // floating Pt3Mtx[TJ1200_MN_ELEM * TJ1200_FN_ELEM];         /* Model - Pt3 matrix */
    // floating Pt5DMtx[TJ1200_MN_ELEM * TJ1200_FN_ELEM];        /* Model - Pt5D matrix */
    // floating Pt5Mtx[TJ1200_MN_ELEM * TJ1200_FN_ELEM];         /* Model - Pt5 matrix */
    // floating Ts0Mtx[TJ1200_ALT_ELEM];                         /* Controller and Model - Ts0 break points  */
    // floating Ts0Mtx1D[TJ1200_ALT_ELEM];                       /* Auxiliar matrix - Ts0 */
    // floating Ts0Mtx1DH[TJ1200_ALT_ELEM];                      /* Auxiliar matrix - Ts0 */
    // floating Ts0Mtx2D[TJ1200_FN_ELEM];                        /* Auxiliar matrix - Ts0 */
    // floating Ts0Mtx2DH[TJ1200_FN_ELEM];                       /* Auxiliar matrix - Ts0 */
    // floating Tt4DMtx[TJ1200_MN_ELEM * TJ1200_FN_ELEM];        /* Model - Tt4D matrix */
    // floating Tt4Mtx[TJ1200_MN_ELEM * TJ1200_FN_ELEM];         /* Model - Tt4 matrix */
    // floating Tt5DMtx[TJ1200_MN_ELEM * TJ1200_FN_ELEM];        /* Model - Tt5D matrix */
    // floating Tt5Mtx[TJ1200_MN_ELEM * TJ1200_FN_ELEM];         /* Model - Tt5 matrix */
    // floating WcHPCMapMtx[TJ1200_FAN_NC * TJ1200_FAN_PR];      /* Model - Wc break points matrix - HPC map */
    // floating WfMtx[TJ1200_MN_ELEM * TJ1200_FN_ELEM];          /* Model - Wf matrix */
...
/******** COPYFROM START: FADEC_LOADPARS *********/
    ...
    // NcFANshContMtx = (floating *)malloc(PowerMan_Elem * sizeof(floating));
    ...
    // getTJ1200FADECMtx(&AMtx[0], &ASVec[0], &AltLinVec[0], &BMtx[0], &DSVec[0],

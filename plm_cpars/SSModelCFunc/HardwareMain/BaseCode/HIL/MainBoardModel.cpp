...
/******** COPYFROM END: HIL_VARS_1 ********/	

/******** COPYFROM START: HIL_INIT_FAULTS ********/
...
/******** COPYFROM END: HIL_INIT_FAULTS ********/

/******** COPYFROM START: HIL_VARS_2 ********/
...
floating Tsample = 0.001 * TICK;                      /* Sampling Time */
...
/* Bearing 0 data */
floating DelT_Bear0[3] = {1, 50, 20};                 /* Temperature decrease if maximum oil flow is used at given RPME */
floating TNOil_Bear0[3] = {300, 415, 450};			/* Temperature reached if no oil is used at the given RPME */

/* Bearing 1 data */
floating DelT_Bear1[3] = {1, 40, 70};                 /* Temperature decrease if maximum oil flow is used at given RPME */
floating TNOil_Bear1[3] = {300, 400, 480};			/* Temperature reached if no oil is used at the given RPME */

/* Bearing 2 Data */
floating DelT_Bear2[3] = {1, 50, 50};                 /* Temperature decrease if maximum oil flow is used at given RPME */
floating TNOil_Bear2[3] = {300, 410, 480};			/* Temperature reached if no oil is used at the given RPME */
...
//printf("model_mf=%f\n", model_mf);
        ...
        {								//TICK value received from FADEC, used on HIL Sync Mode. Informs the model the interval of the simulation in miliseconds
            tickFromFADEC = (floating) msg.value;
        ...
        {
            syncTime_ms = (floating) msg.value;
...
/******** COPYFROM START: SINGLESTOP_RESET ********/ 
...
/******** COPYFROM START: MATRICES_AND_CONSTANTS ********/
        ...
        if (Reset == 0)
        {
            ...
            NcMtx = (floating *)malloc(SteadyOp_Elem * sizeof(floating));
            Pt21Mtx = (floating *)malloc(SteadyOp_Elem * sizeof(floating));
            Pt3Mtx = (floating *)malloc(SteadyOp_Elem * sizeof(floating));
            Pt5Mtx = (floating *)malloc(SteadyOp_Elem * sizeof(floating));
            Pt6Mtx = (floating *)malloc(SteadyOp_Elem * sizeof(floating));
            Tt21Mtx = (floating *)malloc(SteadyOp_Elem * sizeof(floating));
            Tt3Mtx = (floating *)malloc(SteadyOp_Elem * sizeof(floating));
            Tt4Mtx = (floating *)malloc(SteadyOp_Elem * sizeof(floating));
            Tt5Mtx = (floating *)malloc(SteadyOp_Elem * sizeof(floating));
            Tt6Mtx = (floating *)malloc(SteadyOp_Elem * sizeof(floating));
            ...
            Pt21DMtx = (floating *)malloc(SteadyOp_Elem * sizeof(floating));
            Pt3DMtx = (floating *)malloc(SteadyOp_Elem * sizeof(floating));
            Pt5DMtx = (floating *)malloc(SteadyOp_Elem * sizeof(floating));
            Pt6DMtx = (floating *)malloc(SteadyOp_Elem * sizeof(floating));
            Tt21DMtx = (floating *)malloc(SteadyOp_Elem * sizeof(floating));
            Tt3DMtx = (floating *)malloc(SteadyOp_Elem * sizeof(floating));
            Tt4DMtx = (floating *)malloc(SteadyOp_Elem * sizeof(floating));
            Tt5DMtx = (floating *)malloc(SteadyOp_Elem * sizeof(floating));
            Tt6DMtx = (floating *)malloc(SteadyOp_Elem * sizeof(floating));

            /* Matrices used for sub-idle calculations */
            AwmMtx = (floating *)malloc(MN_Elem * sizeof(floating));
            AshMtx = (floating *)malloc(MN_Elem * sizeof(floating));
            BwmMtx = (floating *)malloc(MN_Elem * sizeof(floating));
            BshMtx = (floating *)malloc(MN_Elem * sizeof(floating));
            RPMwmMtx = (floating *)malloc(MN_Elem * sizeof(floating));
            RPMshMtx = (floating *)malloc(MN_Elem * sizeof(floating));
            Tt4CshMtx = (floating *)malloc(1 * sizeof(floating));
            Tt4DshMtx = (floating *)malloc(1 * sizeof(floating));
            Tt4shMtx = (floating *)malloc(1 * sizeof(floating));
            WfshMtx = (floating *)malloc(1 * sizeof(floating));


            /* Low Pressure Compressor or Fan */
            NcFANMapMtx = (floating *)malloc(NcFANMap_Elem * sizeof(floating));
            WcFANStallMtx = (floating *)malloc(NcFANMap_Elem * sizeof(floating));
            PRFANStallMtx = (floating *)malloc(NcFANMap_Elem * sizeof(floating));
            WcFANMapMtx = (floating *)malloc(WcFANMap_Elem * sizeof(floating));
            PRFANMapMtx = (floating *)malloc(WcFANMap_Elem * sizeof(floating));
            EffFANMapMtx = (floating *)malloc(WcFANMap_Elem * sizeof(floating));

            /* High Pressure Compressor */
            NcHPCMapMtx = (floating *)malloc(NcHPCMap_Elem * sizeof(floating));
            WcHPCStallMtx = (floating *)malloc(NcHPCMap_Elem * sizeof(floating));
            PRHPCStallMtx = (floating *)malloc(NcHPCMap_Elem * sizeof(floating));
            WcHPCMapMtx = (floating *)malloc(WcHPCMap_Elem * sizeof(floating));
            PRHPCMapMtx = (floating *)malloc(WcHPCMap_Elem * sizeof(floating));
            EffHPCMapMtx = (floating *)malloc(WcHPCMap_Elem * sizeof(floating));

            /* Turbine */
            NcHPTMapMtx = (floating *)malloc(NcHPTMap_Elem * sizeof(floating));
            WcHPTMapMtx = (floating *)malloc(WcHPTMap_Elem * sizeof(floating));
            EffHPTMapMtx = (floating *)malloc(WcHPTMap_Elem * sizeof(floating));
            PRHPTMapMtx = (floating *)malloc(PRHPTMap_Elem * sizeof(floating));
            ...
            MapFAN2D = (floating *)malloc(WcFANMap_Elem * sizeof(floating));
            MapFAN2DH = (floating *)malloc(WcFANMap_Elem * sizeof(floating));
            MapFAN1D = (floating *)malloc(Wc_per_Nc_FAN * sizeof(floating));
            MapFAN1DH = (floating *)malloc(Wc_per_Nc_FAN * sizeof(floating));
        ...
        else
        {
            ...
            /* Matrices used for sub-idle calculations */
            AwmMtx = (floating *)realloc(AwmMtx,MN_Elem * sizeof(floating));
            AshMtx = (floating *)realloc(AshMtx,MN_Elem * sizeof(floating));
            BwmMtx = (floating *)realloc(BwmMtx,MN_Elem * sizeof(floating));
            BshMtx = (floating *)realloc(BshMtx,MN_Elem * sizeof(floating));
            RPMwmMtx = (floating *)realloc(RPMwmMtx,MN_Elem * sizeof(floating));
            RPMshMtx = (floating *)realloc(RPMshMtx,MN_Elem * sizeof(floating));
            Tt4CshMtx = (floating *)realloc(Tt4CshMtx,1 * sizeof(floating));
            Tt4DshMtx = (floating *)realloc(Tt4DshMtx,1 * sizeof(floating));
            Tt4shMtx = (floating *)realloc(Tt4shMtx,1 * sizeof(floating));
            WfshMtx = (floating *)malloc(1 * sizeof(floating));
...
/******** COPYFROM END: MATRICES_AND_CONSTANTS ********/
...
//    FNpc = RefCAN;
    ...
    */
    ...
    if (HILMode != 0 && bit_start == 1) {   //if it is HIL Mode,
     ...
     OPRPM = ( (floating)model_oilFlow / 5 ) * 12000;     //The oilflow conversion is: 0~5V to 0~12000RPM. IMPORTANT: the max RPM of oilpump is 9000 RPM = 3.75V.
...
//                                                               //but the analog output is configured to 0~10V to the same 0~5V range, i.e. it floatings the input command, so it is necesary to divide the command by 2.

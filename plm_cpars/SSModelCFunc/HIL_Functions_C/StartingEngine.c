...
void StartingEngine(struct EngineStart *Pointer, struct EnginePars *ParsP, 
                    floating *AwmMtxP, floating *AshMtxP, floating *BwmMtxP, 
                    floating *BshMtxP, floating *RPMwmMtxP, floating *RPMshMtxP, floating *WfshMtxP, 
                    floating *Tt4CshMtxP, floating *Tt4DshMtxP, floating *Tt4shMtxP,
                    floating *A, floating *B, floating *D, floating RPM, floating NDes,
                    floating MN, floating Mwm, floating *MNLinVecP, floating MN_Elem,
                    floating Altitude, floating *AltLinVecP, floating Alt_Elem,
                    floating Fnpc, floating *FNPerContMtxP, floating Fn_Elem,
                    floating *Mtx2DP, floating *Mtx2DHP, floating *Mtx1DP, floating *Mtx1DHP,
                    floating PNdotSL, floating PuSL, floating PNSL, floating PTSL, 
                    floating PNdot, floating Pu, floating PN, floating PT,
                    floating Tsample)
{
...
// floating Teste = InterpValue(&Index3D, FNPerContMtxP, Mtx2DP, Mtx2DHP, Mtx1DP, Mtx1DHP, MN_Elem * Fn_Elem, Fn_Elem);        
...
// floating Teste = InterpValue(&Index3D, MNLinVecP, Mtx2DP, Mtx2DHP, Mtx1DP, Mtx1DHP, MN_Elem, MN_Elem);

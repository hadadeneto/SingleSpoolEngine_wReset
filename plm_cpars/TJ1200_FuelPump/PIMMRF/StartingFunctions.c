...
// void FuelIncrease(digital_t *digitalP, double RPM, double RPMChange, double RPMIgnOff, double Tt4, 
// 				double Tt4FlameOn, double *WfP, double *WfChangeP, double WfInit, double WfRampCoef, 
// 				double *RampTimeP, double Ts, int *statusP, int NextStatus)
				...
				double *RampTimeP, double Ts, int *statusP, int NextStatus)
{
	...
	if (Tt4 > Tt4FlameOn & RampAllowed == 1)
	{
		...
		if (RPM < RPMChange)
		{
			...
			FuelRampSR(WfP, WfInit, WfRampCoef, RampTimeP, Ts);

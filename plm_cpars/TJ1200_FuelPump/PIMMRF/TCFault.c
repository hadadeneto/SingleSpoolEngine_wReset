...

{
    ...
    if (FaultsP->SensFaults.Ts2_0_SCV)
    {
        Ts2_0->Faults.SCV = 1;
    }
    /* Verifies each sensor and alters its value depending on the fault */
    if (FaultsP->SensFaults.Ts2_0_SCG)
    {
        Ts2_0->Faults.SCG = 1;
    }
    /* Verifies each sensor and alters its value depending on the fault */
    if (FaultsP->SensFaults.Ts2_0_Open)
    {
        Ts2_0->Faults.OC = 1;
    ...
    /* Verifies each sensor and alters its value depending on the fault */
    if (FaultsP->SensFaults.Ts2_1_SCV)
    {
        Ts2_1->Faults.SCV = 1;
    }
    /* Verifies each sensor and alters its value depending on the fault */
    if (FaultsP->SensFaults.Ts2_1_SCG)
    {
        Ts2_1->Faults.SCG = 1;
    }
    /* Verifies each sensor and alters its value depending on the fault */
    if (FaultsP->SensFaults.Ts2_1_Open)
    {
        Ts2_1->Faults.OC = 1;
    ...
    /* Verifies each sensor and alters its value depending on the fault */
    if (FaultsP->SensFaults.Tt4_0_SCV)
    {
        Tt4_0->Faults.SCV = 1;
    }
    /* Verifies each sensor and alters its value depending on the fault */
    if (FaultsP->SensFaults.Tt4_0_SCG)
    {
        Tt4_0->Faults.SCG = 1;
    }
    /* Verifies each sensor and alters its value depending on the fault */
    if (FaultsP->SensFaults.Tt4_0_Open)
    {
        Tt4_0->Faults.OC = 1;
    ...
    /* Verifies each sensor and alters its value depending on the fault */
    if (FaultsP->SensFaults.Tt4_1_SCV)
    {
        Tt4_1->Faults.SCV = 1;
    }
    /* Verifies each sensor and alters its value depending on the fault */
    if (FaultsP->SensFaults.Tt4_1_SCG)
    {
        Tt4_1->Faults.SCG = 1;
    }
    /* Verifies each sensor and alters its value depending on the fault */
    if (FaultsP->SensFaults.Tt4_1_Open)
    {
        Tt4_1->Faults.OC = 1;
    ...
    /* Verifies each sensor and alters its value depending on the fault */
    if (FaultsP->SensFaults.Tt4_2_SCV)
    {
        Tt4_2->Faults.SCV = 1;
    }
    /* Verifies each sensor and alters its value depending on the fault */
    if (FaultsP->SensFaults.Tt4_2_SCG)
    {
        Tt4_2->Faults.SCG = 1;
    }
    /* Verifies each sensor and alters its value depending on the fault */
    if (FaultsP->SensFaults.Tt4_2_Open)
    {
        Tt4_2->Faults.OC = 1;

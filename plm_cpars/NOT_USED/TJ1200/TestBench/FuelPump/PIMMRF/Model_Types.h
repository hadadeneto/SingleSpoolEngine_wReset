...
struct EnginePars
{
	...
	double POilMin, Valve_Fuel, Ign_Time, Ign_Delta, Fuel_BOut;
	double Ath, NDes;
    double TCSCV, TCSCG, TCOPEN, PSSHORT, PFUELSHORT, PSSOPEN, Tt4HIGH, Tt4BLLCK, Tt4SHLCK, RPMHIGH;

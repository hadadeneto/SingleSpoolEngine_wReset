...
#define S_FUNCTION_NAME  PIMMRF_GEJ85_MainLoop
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	double Ps3MinMtx[GEJ85_ALT_ELEM * GEJ85_MN_ELEM];
    ...
    if(Authorize == 1)
    {
        ...
        PIMinMaxGEJ85(&ContStart, &ContInput, &ContOutput, &digitalWord, &keysWord,
					   NcFANContMtx, FNperContMtx, N_KpMtx, N_KiMtx, Ps3MinMtx, Ts);

...
#ifndef GETGEJ85MTX_H
#define GETGEJ85MTX_H

void getGEJ85Mtx(double *NcFANContMtx, double *N_KpMtx, double *N_KiMtx, double *FNperContMtx, double *NcMtx, double *Pt21Mtx, double *Pt3Mtx, double *Pt5Mtx, double *Pt6Mtx,
	...
	double *NcHPCMapMtx, double *WcHPCMapMtx, double *WcHPCStallMtx, double *PRHPCMapMtx, double *PRHPCStallMtx, double *EffHPCMapMtx, double *MNLinVec, double *AltLinVec);

#ifndef GETTJ300ARHILMTX_H
#define GETTJ300ARHILMTX_H
...
void getTJ300ARHILMtx(floating *AshMtx, floating *AwmMtx, floating *BshMtx, floating *BwmMtx, floating *EffFANMapMtx, 

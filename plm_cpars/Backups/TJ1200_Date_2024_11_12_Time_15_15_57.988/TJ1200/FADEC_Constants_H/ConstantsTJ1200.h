...
#define TJ1200_TIME_BEFORE_RAMP			5//5//3-> At  TestBench			//Seconds
...
#define TJ1200_FUEL_RAMP                0.015//0.012//0.01//0.007//0.005//0.0030//0.0020//0.0012    Older values ->//0.0025//0.003//0.002//0.00175		// = 0.01 * 0.175 - Absolute/Second (1% every second) - CHANGE IF MAXIMUM VALUE IS CHANGED!!!
#define TJ1200_FUEL_PERC				0.2 //0.1 -> At TestBench		//Percentual Value
#define TJ1200_FUEL_RAMP_LOW			0.015//0.009//0.008//0.005//0.003//0.002//0.0012//0.0008     Older values ->//0.0006//0.000875//0.000475 // = 0.005 * 0.175 - //Absolute/Second (0.5% every second) - CHANGE IF MAXIMUM VALUE IS CHANGED!!!

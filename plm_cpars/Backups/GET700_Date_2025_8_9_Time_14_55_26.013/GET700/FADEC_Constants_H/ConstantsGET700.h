...
#define GET700_ALT_ELEM				       13
#define GET700_MN_ELEM 				       10
#define GET700_FN_ELEM				       18
#define GET700_TOTAL_ELEM			       2340
#define GET700_AS_ELEM				       6

/* Components Maps Element Numbers */
#define GET700_FAN_NC                      7
#define GET700_FAN_PR                      11
#define GET700_HPT_NC				       7
#define GET700_HPT_PR				       21

/* Engine Design Point Constants */
#define GET700_NDES                        16540
#define GET700_Ath_NOZZLE                  0.062862
...
/* Engine Limits */
#define GET700_NMAX					16540
#define GET700_NMAXREF               16540
#define GET700_TT4MAX				1250
#define GET700_TT4MAXREF             1250
#define GET700_TT5MAX				1005
#define GET700_TT5MAXREF             1005
#define GET700_SMMIN					15
#define GET700_RUMIN					2.8e-7

/* Maximum Pump Fuel Flow */
#define GET700_WFMAX					0.62			//kg/s

/* Controller Constant Gains */
#define GET700_KPTT4					0
#define GET700_KITT4					0.0039328
#define GET700_KBN					20000
#define GET700_KBT					1000//10000

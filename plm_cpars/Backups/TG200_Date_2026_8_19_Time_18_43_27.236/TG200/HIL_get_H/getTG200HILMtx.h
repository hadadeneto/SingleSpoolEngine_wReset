#ifndef GETTG200HILMTX_H
#define GETTG200HILMTX_H
...
void getTG200HILMtx(floating *AshMtx, floating *AwmMtx, floating *BshMtx, floating *BwmMtx, floating *EffFANMapMtx, 

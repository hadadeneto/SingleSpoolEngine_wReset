...
MissionName = ['SIATTMission_3_ISA_' num2str(dTMission)];
...
MissionName = [ 'SIATTMission_3_RPMMatch_ISA_' num2str(dTTestBench)];
...
MissionName = ['SIATTMission_3_WfMatch_ISA_' num2str(dTTestBench)];
...
if SaveFigs == 1
    Namefig = [FigureFolderword filesep 'M3_RPM_ISA_' num2str(dTTestBench) '.png'];
...
if SaveFigs == 1
    Namefig = [FigureFolderword filesep 'M3_FF_ISA_' num2str(dTTestBench) '.png'];
    FigAutoSave(Namefig,fig)
end
